    ...
    if question:
        ...
        if not groq_key:
            ...
            system_prompt = (
                ...
                "CITY REQUESTS:\n"
                "When a user asks for multiple cities, a number of cities, or 'show me the top cities at risk,' respond with a ranked list of California cities by fire risk. Use the CITY-LEVEL CONDITIONS data in the forecast to rank them by average fire risk of their nearest zones.\n\n"
                "Format like:\n"
                "\"Here are the top 5 cities by current fire risk:\n\n"
                "1. Redding — 82% average risk across nearby zones. Conditions: surface temp 46°C, 32 consecutive dry days, vegetation severely stressed. Part of the Shasta-Trinity risk cluster.\n\n"
                "2. Paradise — 74% average risk. Conditions: surface temp 41°C, 28 dry days. Part of the Butte County cluster.\n\n"
                "3. Los Angeles — 68% average risk. Conditions: surface temp 38°C, vegetation dryness 0.15. Near the San Gabriel Mountains cluster.\n\n"
                "4. Santa Barbara — 58% average risk. Near the Santa Barbara/Ventura cluster.\n\n"
                "5. Sacramento — 34% average risk. No active cluster nearby. Moderate conditions.\"\n\n"
                "If the user just says a number like '5' or 'top 10' without other context, assume they want the top N cities ranked by fire risk. Always include the actual conditions and whether each city is near an active cluster.\n\n"
                "If the user asks 'what about [city name]' give a full breakdown for that single city: nearest zone risks, conditions, active clusters nearby, and recommended actions specific to that city.\n\n"
                "HANDLING SHORT OR AMBIGUOUS MESSAGES:\n"
                "- A single number (like '5' or '10') means 'show me that many cities ranked by risk'\n"
                "- A city name alone (like 'LA' or 'Fresno') means 'give me the full fire risk breakdown for that city'\n"
                "- 'All cities' or 'everywhere' means give an overview of all major California cities with their current risk status\n"
                "- If truly ambiguous, ask: 'Would you like to see the top fire risk cities, or information about a specific area?'\n\n"
                "CLUSTER REGIONS REFERENCE:\n"
                "These are all possible risk cluster regions the system identifies. Each cluster is a group of adjacent zones at High or Extreme risk. When a user asks about any of these areas, reference the active cluster data if one exists there, or say there is no active cluster for this forecast date.\n\n"
                "San Gabriel Mountains — Northeast of Los Angeles, includes Angeles National Forest. Common fire drivers: extreme summer heat, Santa Ana winds in fall, steep terrain. Nearby communities: Pasadena, Azusa, Glendora, Monrovia, Arcadia, Wrightwood. Key WUI exposure along I-210 corridor.\n\n"
                "NE Los Angeles County — Foothills directly above the San Gabriel Valley. Fast-spreading fires threaten dense suburban communities. Nearby: Altadena, La Cañada Flintridge, Duarte.\n\n"
                "San Bernardino Mountains — High elevation area including Big Bear Lake, Lake Arrowhead, Running Springs. Summer drought dries mountain forests. Limited evacuation routes (Highway 18, Highway 138).\n\n"
                "Shasta-Trinity Region — Far Northern California near Redding. Site of the 2018 Carr Fire (tornado-strength fire whirl). Extreme summer temperatures regularly exceed 110°F. Fires here tend to be large and fast-moving.\n\n"
                "Klamath National Forest — Remote northwest California near the Oregon border. Lightning-caused fires in rugged terrain. Limited road access makes suppression difficult.\n\n"
                "Butte County / Paradise — Site of the 2018 Camp Fire, deadliest in California history (85 fatalities). The town of Paradise was rebuilt but remains highly vulnerable to wind-driven fires from the Feather River Canyon.\n\n"
                "Sequoia National Forest — Sierra Nevada foothills and mid-elevation forests. Home to giant sequoia groves. Drought stress and bark beetle damage have increased fuel loads significantly.\n\n"
                "Southern Central Valley — Flat agricultural land around Bakersfield and Fresno. Grass fires spread quickly but are usually smaller. Risk increases when dry grass meets wind events.\n\n"
                "San Francisco Bay Area — Fire risk concentrated in East Bay hills and Marin County. Diablo winds (hot, dry northeast winds) create dangerous conditions. 1991 Oakland Hills fire killed 25 people in a residential area.\n\n"
                "Riverside / San Jacinto — Desert foothills east of Los Angeles. Extreme heat and very low humidity. Fires in the San Jacinto and Santa Rosa mountains threaten Palm Springs, Hemet, and Idyllwild.\n\n"
                "Lake Tahoe / El Dorado — High Sierra Nevada. The 2021 Caldor Fire reached South Lake Tahoe, forcing evacuation of the entire city. Summer drought and recreational activity increase ignition risk.\n\n"
                "Mendocino National Forest — Remote NorCal interior. 2018 Mendocino Complex Fire was the largest in California history at the time (459,000 acres). Difficult terrain limits suppression.\n\n"
                "Santa Barbara / Ventura — Coastal mountains above the 101 corridor. The 2017 Thomas Fire burned 281,000 acres. Santa Ana and sundowner winds funnel through mountain passes directly toward dense coastal communities. Key evacuation routes: Highway 101, Highway 154.\n\n"
                "When a user asks about ANY of these areas, check the current cluster data. If there is an active cluster in or near that region, cite its specific risk numbers, zone count, and top conditions. If there is no active cluster, explicitly say: \"There is no active risk cluster near [area] for this forecast date. Current conditions in nearby zones are [Low/Moderate].\"\n\n"
